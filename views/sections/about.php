...
<head>
    ...
    <title>Sobre Nosotros - LU Decoraciones</title>
...
A lo largo de su carrera, Lupita ha trabajado en todo tipo de eventos, incluyendo fiestas infantiles, cumpleaños, quinceañeras y bodas, adaptando su estilo a la temática y necesidades de cada cliente. Con una atención meticulosa a los detalles, desde arcos de globos vibrantes hasta fondos elegantes para fotografías, LU Decoraciones busca superar las expectativas de cada cliente, convirtiendo cualquier espacio en una experiencia visual única.

            </div>
            <div class="about-image">
                <img src="../../assets/images/img10.jpeg" alt="Lupita Ordoñez">
            </div>
        </section>
    </main>
